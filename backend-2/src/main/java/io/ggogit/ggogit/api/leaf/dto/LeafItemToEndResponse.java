...
public class LeafItemToEndResponse {
    ...
    public void addItem(TreeNode node, List<LeafTag> tags, Long leafId) {
        items.add(LeafItemDto.of(node, tags, leafId));
    }
    ...
    private static class LeafItemDto {
        ...
        public static LeafItemDto of(TreeNode node, List<LeafTag> tags, Long leafId) {
