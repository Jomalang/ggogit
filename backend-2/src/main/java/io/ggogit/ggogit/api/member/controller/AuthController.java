...
import io.ggogit.ggogit.domain.member.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<String > athentication(
        @RequestBody String accessToken
    ){
        MemberLoginResponse  = authService.athentication(accessToken);
        if(response == null){
